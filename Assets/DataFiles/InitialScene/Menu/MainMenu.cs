...
public class MainMenu : MonoBehaviour
{
    ...
    private MainMenuItem _userMenuItem;
    private MainMenuItem _settingsMenuItem;
    private MainMenuItem _languageMenuItem;
    private MainMenuItem _helpMenuItem;
    private MainMenuItem _exitMenuItem;
    private MainMenuItem _logOutMenuItem;
    ...
    private void Awake()
    {
        ...
        _userMenuItem = _userMenuItemGO.GetComponent<MainMenuItem>();
        _settingsMenuItem = _settingsMenuItemGO.GetComponent<MainMenuItem>();
        _languageMenuItem = _languageMenuItemGO.GetComponent<MainMenuItem>();
        _helpMenuItem= _helpMenuItemGO.GetComponent<MainMenuItem>();
        _exitMenuItem = _exitMenuItemGO.GetComponent<MainMenuItem>();
        _logOutMenuItem = _logOutMenuItemGO.GetComponent<MainMenuItem>();
    }
