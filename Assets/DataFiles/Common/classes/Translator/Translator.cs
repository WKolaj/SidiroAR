...
public static class Translator
{
    ...
    private static Dictionary<string, Dictionary<string, string>> _translations = new Dictionary<string, Dictionary<string, string>>()
    {
        ["pl"] = new Dictionary<string, string>()
        {
            ...
            ["SettingsPage.PositionDeltaDropDown.LabelText"] = "Dokładność pozycjonowania",
            ["SettingsPage.PositionDeltaDropDown.PositionOption05"] = "0.5cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption10"] = "1cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption20"] = "2cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption50"] = "5cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption100"] = "10cm",
            ["SettingsPage.RotationDeltaDropDown.LabelText"] = "Dokładność obrotu",
            ["SettingsPage.RotationDeltaDropDown.RotationOption025"] = "0.25°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption050"] = "0.5°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption100"] = "1°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption200"] = "2°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption500"] = "5°",
        ...
        ["en"] = new Dictionary<string, string>()
        {
            ...
            ["SettingsPage.PositionDeltaDropDown.LabelText"] = "Positioning accuracy",
            ["SettingsPage.PositionDeltaDropDown.PositionOption05"] = "0.5cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption10"] = "1cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption20"] = "2cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption50"] = "5cm",
            ["SettingsPage.PositionDeltaDropDown.PositionOption100"] = "10cm",
            ["SettingsPage.RotationDeltaDropDown.LabelText"] = "Rotating accuracy",
            ["SettingsPage.RotationDeltaDropDown.RotationOption025"] = "0.25°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption050"] = "0.5°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption100"] = "1°",
            ["SettingsPage.RotationDeltaDropDown.RotationOption200"] = "2°",
